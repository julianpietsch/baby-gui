function trackCellsOverlap(cExperiment,positionsToTrack,cellMovementThresh)
%trackCellsOverlap(cExperiment,positionsToTrack,cellMovementThresh)
%-------------------------------------------------------------
...
for i=1:length(positionsToTrack)
    ...
    cTimelapse.trackCellsOverlap(cellMovementThresh);
